...
function AppContent() {
  ...
  if (isLoading) {
    return (
      <div className={`min-h-screen flex items-center justify-center transition-colors duration-200 ${isDarkMode
          ? 'bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900'
          : 'bg-gradient-to-br from-rose-50 via-blue-50 to-amber-50'
        }`}>
        <div className="text-center">
          <div className={`animate-spin rounded-full h-12 w-12 border-b-2 mx-auto mb-4 transition-colors duration-200 ${isDarkMode ? 'border-rose-300' : 'border-rose-400'
            }`}></div>
  ...
  return (
    <div className={`min-h-screen transition-colors duration-200 ${isDarkMode
        ? 'bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900'
        : 'bg-gradient-to-br from-rose-50 via-blue-50 to-amber-50'
      }`}>
      <Routes>
